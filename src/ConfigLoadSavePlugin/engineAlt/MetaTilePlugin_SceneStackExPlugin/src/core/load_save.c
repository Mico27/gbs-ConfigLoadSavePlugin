...
// SRAM bank 0 holds the MetaTile plugin's map and collision data and bank 1 holds
// the SceneStackEx plugin's scene stack, so the save slots start at bank 2
// however low "Starting SRAM bank" is set.
#define SAVE_SRAM_RESERVED_BANKS 2
