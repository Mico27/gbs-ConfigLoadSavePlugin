...
// SRAM bank 0 holds the MetaTile plugin's map and collision data, so the save
// slots start at bank 1 however low "Starting SRAM bank" is set.
#define SAVE_SRAM_RESERVED_BANKS 1
