...
// SRAM banks another plugin owns, counted from bank 0. Nothing shares SRAM with
// the base engine; the engineAlt variants raise this.
#define SAVE_SRAM_RESERVED_BANKS 0
